...
You can [override](https://docs.kubermatic.com/kubeone/v1.11/references/kubeone-cluster-v1beta2/#cloudproviderspec) the cloud-config
...
| [random_integer.ipv6_cidr_block](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/integer) | resource |
