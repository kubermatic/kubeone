...
[docs-tf-loadbalancer]: https://docs.kubermatic.com/kubeone/v1.11/examples/ha-load-balancing/
...
| <a name="input_lb_operating_system"></a> [lb\_operating\_system](#input\_lb\_operating\_system) | Image to use for loadbalancer provisioning | `string` | `"ubuntu_24_04"` | no |
