...
| <a name="input_public_ip_wait_timeout"></a> [public\_ip\_wait\_timeout](#input\_public\_ip\_wait\_timeout) | Time to wait until resolving data.azurerm\_public\_ip.control\_plane | `string` | `"90s"` | no |
