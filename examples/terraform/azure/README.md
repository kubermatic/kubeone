...
| <a name="input_image_references"></a> [image\_references](#input\_image\_references) | map with image references used for control plane | <pre>map(object({<br>    publisher    = string<br>    offer        = string<br>    sku          = string<br>    version      = string<br>    ssh_username = string<br>    worker_os    = string<br>  }))</pre> | <pre>{<br>  "centos": {<br>    "offer": "CentOS",<br>    "publisher": "OpenLogic",<br>    "sku": "7_9",<br>    "ssh_username": "centos",<br>    "version": "latest",<br>    "worker_os": "centos"<br>  },<br>  "flatcar": {<br>    "offer": "flatcar-container-linux",<br>    "publisher": "kinvolk",<br>    "sku": "stable",<br>    "ssh_username": "core",<br>    "version": "2905.2.5",<br>    "worker_os": "flatcar"<br>  },<br>  "rhel": {<br>    "offer": "rhel-byos",<br>    "publisher": "RedHat",<br>    "sku": "rhel-lvm85",<br>    "ssh_username": "root",<br>    "version": "8.5.20220316",<br>    "worker_os": "rhel"<br>  },<br>  "rockylinux": {<br>    "offer": "rocky-linux-8-5",<br>    "publisher": "procomputers",<br>    "sku": "rocky-linux-8-5",<br>    "ssh_username": "rocky",<br>    "version": "8.5.20211118",<br>    "worker_os": "rockylinux"<br>  },<br>  "ubuntu": {<br>    "offer": "0001-com-ubuntu-server-focal",<br>    "publisher": "Canonical",<br>    "sku": "20_04-lts",<br>    "ssh_username": "ubuntu",<br>    "version": "latest",<br>    "worker_os": "ubuntu"<br>  }<br>}</pre> | no |
