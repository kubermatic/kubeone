...
date = 2022-06-01T15:38:37+02:00
weight = 11
+++
## v1beta2
...
| maxPods | MaxPods configures maximum number of pods per node. Default value is 0, which means that default value provided by kubelet will be used (max. 110 pods per node) | int32 | false |
