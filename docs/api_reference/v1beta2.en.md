...
date = 2026-05-13T17:03:05+03:00
weight = 11
+++
## v1beta2
...
| machineAnnotations | MachineAnnotations set MachineDeployment.Spec.Template.Spec.ObjectMeta.Annotations as a way to annotate resulting Nodes\n\nDeprecated: Use NodeAnnotations instead. | map[string]string | false |
