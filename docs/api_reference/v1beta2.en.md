...
date = 2026-02-20T17:03:23+01:00
weight = 11
+++
## v1beta2
...
| l2Announcements | L2Announcements enables the Layer 2 announcement feature for the Cilium CNI plugin. If not set, Cilium will use its default behavior. | bool | true |
...
| machineAnnotations | This field is NOOP and is only provided for backward compatibility reasons\n\nDeprecated: Use NodeAnnotations instead. | map[string]string | false |
