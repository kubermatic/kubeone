...
# [v0.9.0](https://github.com/kubermatic/kubeone/releases/tag/v0.9.0) - 2019-06-20

## Action Required

* KubeOne Terraform integration now requires Terraform v0.12+
  * In order to use the Terraform integration with KubeOne v0.9+,
  please update Terraform to v0.12 or newer
  * KubeOne is not able to parse the Terraform output generated by Terraform
  v0.11 or older anymore
  * The Terraform output format has been changed. KubeOne is not able
  to parse the old output format anymore. Please check the current output format
  used by the [example Terraform scripts](https://github.com/kubermatic/kubeone/blob/986b4bc361c6a0ae5d5319990c54e82c15a66cb3/examples/terraform/aws/output.tf) as a
  reference
...
* Add support for reading the Terraform state directly from the directory ([#495](https://github.com/kubermatic/kubeone/pull/495))
...
* [BREAKING] Change Terraform output format to conform with the KubeOneCluster API ([#503](https://github.com/kubermatic/kubeone/pull/503))
