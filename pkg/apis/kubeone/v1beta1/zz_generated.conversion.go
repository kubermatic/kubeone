...
func autoConvert_v1beta1_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	if in.DynamicWorkers != nil {
		...
		*out = make([]kubeone.DynamicWorkerConfig, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_DynamicWorkerConfig_To_kubeone_DynamicWorkerConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kubeone_KubeOneCluster_To_v1beta1_KubeOneCluster(in *kubeone.KubeOneCluster, out *KubeOneCluster, s conversion.Scope) error {
	...
	if in.DynamicWorkers != nil {
		...
		*out = make([]DynamicWorkerConfig, len(*in))
		for i := range *in {
			if err := Convert_kubeone_DynamicWorkerConfig_To_v1beta1_DynamicWorkerConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kubeone_ProviderSpec_To_v1beta1_ProviderSpec(in *kubeone.ProviderSpec, out *ProviderSpec, s conversion.Scope) error {
	...
	out.Annotations = *(*map[string]string)(unsafe.Pointer(&in.Annotations))
	out.MachineAnnotations = *(*map[string]string)(unsafe.Pointer(&in.MachineAnnotations))
	// WARNING: in.NodeAnnotations requires manual conversion: does not exist in peer-type
	// WARNING: in.MachineObjectAnnotations requires manual conversion: does not exist in peer-type
	out.Labels = *(*map[string]string)(unsafe.Pointer(&in.Labels))
	out.Taints = *(*[]v1.Taint)(unsafe.Pointer(&in.Taints))
	out.SSHPublicKeys = *(*[]string)(unsafe.Pointer(&in.SSHPublicKeys))
	out.OperatingSystem = in.OperatingSystem
