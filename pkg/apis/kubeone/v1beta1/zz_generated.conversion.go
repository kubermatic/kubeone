...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ImageConfiguration)(nil), (*kubeone.ImageConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ImageConfiguration_To_kubeone_ImageConfiguration(a.(*ImageConfiguration), b.(*kubeone.ImageConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.ImageConfiguration)(nil), (*ImageConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_ImageConfiguration_To_v1beta1_ImageConfiguration(a.(*kubeone.ImageConfiguration), b.(*ImageConfiguration), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1beta1_ImageConfiguration_To_kubeone_ImageConfiguration is an autogenerated conversion function.
func Convert_v1beta1_ImageConfiguration_To_kubeone_ImageConfiguration(in *ImageConfiguration, out *kubeone.ImageConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta1_ImageConfiguration_To_kubeone_ImageConfiguration(in, out, s)
}
...
// Convert_kubeone_ImageConfiguration_To_v1beta1_ImageConfiguration is an autogenerated conversion function.
func Convert_kubeone_ImageConfiguration_To_v1beta1_ImageConfiguration(in *kubeone.ImageConfiguration, out *ImageConfiguration, s conversion.Scope) error {
	return autoConvert_kubeone_ImageConfiguration_To_v1beta1_ImageConfiguration(in, out, s)
}
...
func autoConvert_v1beta1_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_ImageConfiguration_To_kubeone_ImageConfiguration(&in.ImageConfiguration, &out.ImageConfiguration, s); err != nil {
		return err
	}
...
func autoConvert_kubeone_KubeOneCluster_To_v1beta1_KubeOneCluster(in *kubeone.KubeOneCluster, out *KubeOneCluster, s conversion.Scope) error {
	...
	if err := Convert_kubeone_ImageConfiguration_To_v1beta1_ImageConfiguration(&in.ImageConfiguration, &out.ImageConfiguration, s); err != nil {
		return err
	}
