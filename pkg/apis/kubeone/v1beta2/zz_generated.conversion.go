...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BaremetalSpec)(nil), (*kubeone.BaremetalSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_BaremetalSpec_To_kubeone_BaremetalSpec(a.(*BaremetalSpec), b.(*kubeone.BaremetalSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.BaremetalSpec)(nil), (*BaremetalSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_BaremetalSpec_To_v1beta2_BaremetalSpec(a.(*kubeone.BaremetalSpec), b.(*BaremetalSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_BaremetalSpec_To_kubeone_BaremetalSpec(in *BaremetalSpec, out *kubeone.BaremetalSpec, s conversion.Scope) error {
	return nil
}

// Convert_v1beta2_BaremetalSpec_To_kubeone_BaremetalSpec is an autogenerated conversion function.
func Convert_v1beta2_BaremetalSpec_To_kubeone_BaremetalSpec(in *BaremetalSpec, out *kubeone.BaremetalSpec, s conversion.Scope) error {
	return autoConvert_v1beta2_BaremetalSpec_To_kubeone_BaremetalSpec(in, out, s)
}

func autoConvert_kubeone_BaremetalSpec_To_v1beta2_BaremetalSpec(in *kubeone.BaremetalSpec, out *BaremetalSpec, s conversion.Scope) error {
	return nil
}

// Convert_kubeone_BaremetalSpec_To_v1beta2_BaremetalSpec is an autogenerated conversion function.
func Convert_kubeone_BaremetalSpec_To_v1beta2_BaremetalSpec(in *kubeone.BaremetalSpec, out *BaremetalSpec, s conversion.Scope) error {
	return autoConvert_kubeone_BaremetalSpec_To_v1beta2_BaremetalSpec(in, out, s)
}
...
func autoConvert_v1beta2_CloudProviderSpec_To_kubeone_CloudProviderSpec(in *CloudProviderSpec, out *kubeone.CloudProviderSpec, s conversion.Scope) error {
	...
	out.Baremetal = (*kubeone.BaremetalSpec)(unsafe.Pointer(in.Baremetal))
...
func autoConvert_kubeone_CloudProviderSpec_To_v1beta2_CloudProviderSpec(in *kubeone.CloudProviderSpec, out *CloudProviderSpec, s conversion.Scope) error {
	...
	out.Baremetal = (*BaremetalSpec)(unsafe.Pointer(in.Baremetal))
