...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Workload)(nil), (*kubeone.Workload)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_Workload_To_kubeone_Workload(a.(*Workload), b.(*kubeone.Workload), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.Workload)(nil), (*Workload)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_Workload_To_v1beta2_Workload(a.(*kubeone.Workload), b.(*Workload), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	out.Workloads = *(*[]kubeone.Workload)(unsafe.Pointer(&in.Workloads))
...
func autoConvert_v1beta2_Workload_To_kubeone_Workload(in *Workload, out *kubeone.Workload, s conversion.Scope) error {
	out.Addon = (*kubeone.Addon)(unsafe.Pointer(in.Addon))
	out.HelmRelease = (*kubeone.HelmRelease)(unsafe.Pointer(in.HelmRelease))
	return nil
}

// Convert_v1beta2_Workload_To_kubeone_Workload is an autogenerated conversion function.
func Convert_v1beta2_Workload_To_kubeone_Workload(in *Workload, out *kubeone.Workload, s conversion.Scope) error {
	return autoConvert_v1beta2_Workload_To_kubeone_Workload(in, out, s)
}

func autoConvert_kubeone_Workload_To_v1beta2_Workload(in *kubeone.Workload, out *Workload, s conversion.Scope) error {
	out.Addon = (*Addon)(unsafe.Pointer(in.Addon))
	out.HelmRelease = (*HelmRelease)(unsafe.Pointer(in.HelmRelease))
	return nil
}

// Convert_kubeone_Workload_To_v1beta2_Workload is an autogenerated conversion function.
func Convert_kubeone_Workload_To_v1beta2_Workload(in *kubeone.Workload, out *Workload, s conversion.Scope) error {
	return autoConvert_kubeone_Workload_To_v1beta2_Workload(in, out, s)
}
