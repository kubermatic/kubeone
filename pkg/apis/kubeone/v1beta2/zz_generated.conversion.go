...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeletConfiguration)(nil), (*kubeone.KubeletConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration(a.(*KubeletConfiguration), b.(*kubeone.KubeletConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.KubeletConfiguration)(nil), (*KubeletConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration(a.(*kubeone.KubeletConfiguration), b.(*KubeletConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration(&in.KubeletConfiguration, &out.KubeletConfiguration, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_kubeone_KubeOneCluster_To_v1beta2_KubeOneCluster(in *kubeone.KubeOneCluster, out *KubeOneCluster, s conversion.Scope) error {
	...
	if err := Convert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration(&in.KubeletConfiguration, &out.KubeletConfiguration, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration(in *KubeletConfiguration, out *kubeone.KubeletConfiguration, s conversion.Scope) error {
	out.ContainerLogMaxSize = in.ContainerLogMaxSize
	return nil
}

// Convert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration is an autogenerated conversion function.
func Convert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration(in *KubeletConfiguration, out *kubeone.KubeletConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta2_KubeletConfiguration_To_kubeone_KubeletConfiguration(in, out, s)
}

func autoConvert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration(in *kubeone.KubeletConfiguration, out *KubeletConfiguration, s conversion.Scope) error {
	out.ContainerLogMaxSize = in.ContainerLogMaxSize
	return nil
}

// Convert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration is an autogenerated conversion function.
func Convert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration(in *kubeone.KubeletConfiguration, out *KubeletConfiguration, s conversion.Scope) error {
	return autoConvert_kubeone_KubeletConfiguration_To_v1beta2_KubeletConfiguration(in, out, s)
}
