...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GCEControlPlane)(nil), (*kubeone.GCEControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GCEControlPlane_To_kubeone_GCEControlPlane(a.(*GCEControlPlane), b.(*kubeone.GCEControlPlane), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.GCEControlPlane)(nil), (*GCEControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_GCEControlPlane_To_v1beta2_GCEControlPlane(a.(*kubeone.GCEControlPlane), b.(*GCEControlPlane), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*GCELoadBalancer)(nil), (*kubeone.GCELoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer(a.(*GCELoadBalancer), b.(*kubeone.GCELoadBalancer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.GCELoadBalancer)(nil), (*GCELoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer(a.(*kubeone.GCELoadBalancer), b.(*GCELoadBalancer), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_GCEControlPlane_To_kubeone_GCEControlPlane(in *GCEControlPlane, out *kubeone.GCEControlPlane, s conversion.Scope) error {
	if err := Convert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer(&in.LoadBalancer, &out.LoadBalancer, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta2_GCEControlPlane_To_kubeone_GCEControlPlane is an autogenerated conversion function.
func Convert_v1beta2_GCEControlPlane_To_kubeone_GCEControlPlane(in *GCEControlPlane, out *kubeone.GCEControlPlane, s conversion.Scope) error {
	return autoConvert_v1beta2_GCEControlPlane_To_kubeone_GCEControlPlane(in, out, s)
}

func autoConvert_kubeone_GCEControlPlane_To_v1beta2_GCEControlPlane(in *kubeone.GCEControlPlane, out *GCEControlPlane, s conversion.Scope) error {
	if err := Convert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer(&in.LoadBalancer, &out.LoadBalancer, s); err != nil {
		return err
	}
	return nil
}

// Convert_kubeone_GCEControlPlane_To_v1beta2_GCEControlPlane is an autogenerated conversion function.
func Convert_kubeone_GCEControlPlane_To_v1beta2_GCEControlPlane(in *kubeone.GCEControlPlane, out *GCEControlPlane, s conversion.Scope) error {
	return autoConvert_kubeone_GCEControlPlane_To_v1beta2_GCEControlPlane(in, out, s)
}

func autoConvert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer(in *GCELoadBalancer, out *kubeone.GCELoadBalancer, s conversion.Scope) error {
...
// Convert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer is an autogenerated conversion function.
func Convert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer(in *GCELoadBalancer, out *kubeone.GCELoadBalancer, s conversion.Scope) error {
	return autoConvert_v1beta2_GCELoadBalancer_To_kubeone_GCELoadBalancer(in, out, s)
}

func autoConvert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer(in *kubeone.GCELoadBalancer, out *GCELoadBalancer, s conversion.Scope) error {
	out.ProjectID = in.ProjectID
	out.Region = in.Region
	out.Network = in.Network
	out.Name = in.Name
...
// Convert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer is an autogenerated conversion function.
func Convert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer(in *kubeone.GCELoadBalancer, out *GCELoadBalancer, s conversion.Scope) error {
	return autoConvert_kubeone_GCELoadBalancer_To_v1beta2_GCELoadBalancer(in, out, s)
}
