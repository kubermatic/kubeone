...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CAConfig)(nil), (*kubeone.CAConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_CAConfig_To_kubeone_CAConfig(a.(*CAConfig), b.(*kubeone.CAConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeone.CAConfig)(nil), (*CAConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeone_CAConfig_To_v1beta2_CAConfig(a.(*kubeone.CAConfig), b.(*CAConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_CAConfig_To_kubeone_CAConfig(in *CAConfig, out *kubeone.CAConfig, s conversion.Scope) error {
	out.CABundle = in.CABundle
	out.CAFile = in.CAFile
	return nil
}

// Convert_v1beta2_CAConfig_To_kubeone_CAConfig is an autogenerated conversion function.
func Convert_v1beta2_CAConfig_To_kubeone_CAConfig(in *CAConfig, out *kubeone.CAConfig, s conversion.Scope) error {
	return autoConvert_v1beta2_CAConfig_To_kubeone_CAConfig(in, out, s)
}

func autoConvert_kubeone_CAConfig_To_v1beta2_CAConfig(in *kubeone.CAConfig, out *CAConfig, s conversion.Scope) error {
	out.CABundle = in.CABundle
	out.CAFile = in.CAFile
	return nil
}

// Convert_kubeone_CAConfig_To_v1beta2_CAConfig is an autogenerated conversion function.
func Convert_kubeone_CAConfig_To_v1beta2_CAConfig(in *kubeone.CAConfig, out *CAConfig, s conversion.Scope) error {
	return autoConvert_kubeone_CAConfig_To_v1beta2_CAConfig(in, out, s)
}
...
func autoConvert_v1beta2_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	out.CABundle = in.CABundle
	if err := Convert_v1beta2_CAConfig_To_kubeone_CAConfig(&in.CertificateAuthority, &out.CertificateAuthority, s); err != nil {
		return err
	}
...
func autoConvert_kubeone_KubeOneCluster_To_v1beta2_KubeOneCluster(in *kubeone.KubeOneCluster, out *KubeOneCluster, s conversion.Scope) error {
	...
	out.CABundle = in.CABundle
	if err := Convert_kubeone_CAConfig_To_v1beta2_CAConfig(&in.CertificateAuthority, &out.CertificateAuthority, s); err != nil {
		return err
	}
