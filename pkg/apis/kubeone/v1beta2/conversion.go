...
func Convert_kubeone_ControlPlaneComponents_To_v1beta2_ControlPlaneComponents(in *kubeoneapi.ControlPlaneComponents, out *ControlPlaneComponents, s conversion.Scope) error {
