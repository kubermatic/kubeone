...
func updateAWSWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateAzureWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateGCEWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateDigitalOceanWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateHetznerWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateNutanixWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateOpenStackWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
...
func updateVSphereWorkerset(existingWorkerSet *kubeonev1beta3.DynamicWorkerConfig, cfg json.RawMessage) error {
