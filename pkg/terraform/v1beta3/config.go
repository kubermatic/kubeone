...
type Config struct {
	...
	KubeOneWorkers struct {
		...
		Value map[string]kubeonev1beta3.DynamicWorkerConfig `json:"value"`
	...
	Proxy struct {
		...
		Value kubeonev1beta3.ProxyConfig `json:"value"`
	} `json:"proxy"`
}
...
func isLeaderHostConfigsOpts(leaderIP string) hostConfigsOpts {
	return func(hosts []kubeonev1beta3.HostConfig) {
		if leaderIP == "" {
			return
		}
...
func (hs *hostsSpec) toHostConfigs(opts ...hostConfigsOpts) []kubeonev1beta3.HostConfig {
	hosts := []kubeonev1beta3.HostConfig{}
...
func (output *Config) Apply(cluster *kubeonev1beta3.KubeOneCluster) error {
	...
	if cp.CloudProvider != nil {
		...
		if err := kubeonev1beta3.SetCloudProvider(cloudProvider, *cp.CloudProvider); err != nil {
			return err
		}
...
func newHostConfig(publicIP, privateIP string, ipv6addr []string, idx int, spec *hostsSpec) kubeonev1beta3.HostConfig {
	var hostname string
	...
	hostConfig := kubeonev1beta3.HostConfig{
		...
		Kubelet:              kubeonev1beta3.KubeletConfig{},
		Labels:               spec.Labels,
...
func setWorkersetFlag(w *kubeonev1beta3.DynamicWorkerConfig, name string, value interface{}) error {
