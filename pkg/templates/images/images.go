...
func baseResources() map[Resource]map[string]string {
	return map[Resource]map[string]string{
		...
		MachineController:      {"*": "quay.io/kubermatic/machine-controller:dd2680d56c209ddec98a0b75c7455ab9e014868f"},
...
func optionalResources() map[Resource]map[string]string {
	return map[Resource]map[string]string{
		...
		// Hetzner CCM
		HetznerCCM: {"*": "docker.io/hetznercloud/hcloud-cloud-controller-manager:v1.15.0"},
